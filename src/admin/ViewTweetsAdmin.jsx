...
const ViewTweetsAdmin = () => {
  ...
  const getTweets = async () => {
    ...
    try {
      const response = await AxiosApi.get(`admin/tweets`);
...
const deleteTweets = async(id) => {
  try {
    await AxiosApi.delete(`admin/deletetweet/${id}`);
            ...
            tweets.map((item) => (
              <div className="rounded overflow-hidden shadow-lg flex flex-col">
                ...
                <div className="px-6 py-4 mb-auto">
                  ...
                  <p className="text-gray-500 text-sm">{item.tweet}</p>
                ...
                <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                  ...
                  <button onClick={()=>deleteTweets(item.id)} className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      height="24px"
...
export default ViewTweetsAdmin;
